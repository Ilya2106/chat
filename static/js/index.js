...
// redirect to '/room/<contactSelect>/'
document.querySelector("#contactSelect").onchange = function () {
    let contactName = document.querySelector("#contactSelect").value
    window.location.pathname = "chat/" + contactName + "/";
}